...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/raw_all_samples_gtplot.jpg", height = 8, width = 14, units = "in", res = 500)
plot(gtplot)
graphics.off()
...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/filtered_all_samples_gtplot.jpg", height = 8, width = 14, units = "in", res = 500)
plot(gtplot)
graphics.off()
...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/filtered_noape_samples_gtplot.jpg", height = 8, width = 14, units = "in", res = 500)
plot(gtplot)
graphics.off()
...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/filtered_noclones_samples_gtplot.jpg", height = 8, width = 14, units = "in", res = 500)
plot(gtplot)
graphics.off()
...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/filtered_noclones_nonha_samples_gtplot.jpg", height = 8, width = 14, units = "in", res = 500)
plot(gtplot)
graphics.off()
