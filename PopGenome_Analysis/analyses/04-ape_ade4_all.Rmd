...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/mtdna_phylogenetic_tree_bl.jpg", height = 8, width = 11, units = "in", res = 500)
plot(bstree_plotObj)
graphics.off()
...
jpeg("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/figures/mtdna_phylogenetic_tree_no-bl.jpg", height = 8, width = 11, units = "in", res = 500)
plot(bstree_plotObj)
graphics.off()
