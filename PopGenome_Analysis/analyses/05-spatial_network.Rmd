...
# Read In MetaData
#---------------------------------------------------- 
smpls <- readRDS("data/derived_data/mtdt.RDS")
...
labsmpls <- smpls$smpls[smpls$vividregion == "Lab"]
...
mtdnanetwork.diff <- mtdnanetwork %>% 
  ...
  dplyr::filter(!(country.x == "CD" & country.y == "CD" )) %>% 
  dplyr::filter(!(x %in% labsmpls | y %in% labsmpls)) %>% 
...
jpeg("figures/mtdna_spatial_network_wide.jpg", height = 8, width = 11, units = "in", res = 500)
plot(mtDNAglobal)
graphics.off()

jpeg("figures/mtdna_spatial_network_long.jpg", height = 11, width = 8, units = "in", res = 500)
plot(mtDNAglobal)
graphics.off()
...
jpeg("figures/mtdna_spatial_network_wide_hammingone.jpg", height = 8, width = 11, units = "in", res = 500)
plot(mtDNAglobal)
graphics.off()

jpeg("figures/mtdna_spatial_network_long_hammingone.jpg", height = 11, width = 8, units = "in", res = 500)
plot(mtDNAglobal)
graphics.off()
