...
# Annotate Variants (NHA Samples Excluded)
```{r}
library(tidyverse)
library(Biostrings)
```
...
snps <- readRDS("~/Documents/GitHub/VivID_Seq/PopGenome_Analysis/data/derived_data/final_vcf_snps.RDS")
